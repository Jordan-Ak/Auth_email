...
from accounts.views import (CurrentUserView, 
                            ListUsersView, PasswordResetConfirmView, PasswordResetSendView,
                            SignUpView, 
                            UserDeleteView, UserEmailVerificationView, 
                            UserPasswordChangeView, UserResendEmailVerificationView,) 
